    ...
    <aside className="h-full fixed top-0 left-0 w-64  bg-black">
      <div className="flex flex-col items-center h-full m-5 mt-5">
        ...
        <ul className="w-full mt-4">
          ...
          <Link href="/create/playlists">
            <a>
              <li
                className={`${
                  router.pathname === "/create/playlists" ? activeLink : inactiveLink
                } flex items-center gap-3 p-2 text-sm rounded cursor-pointer  hover:text-white`}
              >
                <span>
          ...
          <Link href="/episodes">
            <a>
              <li
                className={`${
                  router.pathname === "/episodes" ? activeLink : inactiveLink
                } flex items-center gap-3 p-2 text-sm rounded cursor-pointer  hover:text-white`}
              >
                <span>
                <RssIcon className="h-5 w-5" />
                </span>
                <span className="font-bold">Your Episodes</span>
              </li>
            </a>
          </Link>
